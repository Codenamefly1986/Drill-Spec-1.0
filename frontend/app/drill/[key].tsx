    ...
    <View style={styles.root}>
      ...
      >
        <View style={styles.titleBlock} testID="drill-title-block">
          ...
          <View style={styles.dimensions}>
            <View style={styles.dimBlock}>
              ...
              <Text style={styles.dimValue} testID="drill-diameter-in">
                {drill.diameter_in.toFixed(4)}
              </Text>
            </View>
            <View style={styles.dimBlock}>
              <Text style={styles.dimLabel}>DIAMETER (MM)</Text>
              <Text style={styles.dimValue} testID="drill-diameter-mm">
                {drill.diameter_mm.toFixed(3)}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View>
          ...
          {availableCount === 0 && (
            <Text style={styles.emptyNote}>No length data available for this size.</Text>
          )}
