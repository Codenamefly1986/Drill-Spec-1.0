...
const useStyles = makeStyles((colors) => ({
  ...
  modeBtnTextActive: { color: colors.onBrandPrimary },
  scroll: { flex: 1 },
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.modeRow} testID="tap-mode-row">
        <Pressable
          testID="tap-mode-cutting"
          style={[styles.modeBtn, mode === "cutting" && styles.modeBtnActive]}
          onPress={() => switchMode("cutting")}
        >
          <Text style={[styles.modeBtnText, mode === "cutting" && styles.modeBtnTextActive]}>
            CUTTING
          </Text>
        </Pressable>
        <Pressable
          testID="tap-mode-forming"
          style={[styles.modeBtn, mode === "forming" && styles.modeBtnActive]}
          onPress={() => switchMode("forming")}
        >
          <Text style={[styles.modeBtnText, mode === "forming" && styles.modeBtnTextActive]}>
            FORMING
          </Text>
        </Pressable>
      </View>
